 ...
 */
MapTo('aemdemo/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('aemdemo/components/separator')(SeparatorV1Component);

MapTo('aemdemo/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('aemdemo/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('aemdemo/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('aemdemo/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('aemdemo/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('aemdemo/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('aemdemo/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('aemdemo/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('aemdemo/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('aemdemo/components/accordion')(AccordionV1Component);
MapTo('aemdemo/components/tabs')(TabsV1Component);
...
LazyMapTo('aemdemo/components/teaser')(TeaserV1Component);
...
LazyMapTo('aemdemo/components/carousel')(CarouselV1Component);
...
LazyMapTo('aemdemo/components/text')(LazyTextModule, TextEditConfig);